<?php return array (
  ...
  array (
    'paths' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/resources/views',
    ),
    'compiled' => '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/storage/framework/views',
  ),
  'cors' => 
  array (
    'paths' => 
  ...
  array (
    ...
    'faker_locale' => 'en_US',
    'cipher' => 'AES-256-CBC',
    'key' => 'base64:g1QjNuE8Me6VyOQg2RZKXgCAssJRkvb5cB0rI3YBsks=',
    'previous_keys' => 
    array (
    ),
    'maintenance' => 
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/storage/framework/cache/data',
        'lock_path' => '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/storage/framework/cache/data',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/storage/app/private',
        'serve' => true,
        'throw' => false,
        'report' => false,
      ),
      ...
      array (
        'driver' => 'local',
        'root' => '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/storage/app/public',
    ...
    'links' => 
    array (
      '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/public/storage' => '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/storage/app/public',
    ),
  ),
  'logging' => 
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/storage/logs/laravel.log',
        'level' => 'debug',
  ...
  array (
    ...
    array (
      ...
      'paths' => 
      array (
        0 => '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/resources/views/vendor/mail',
      ),
    ),
  ),
  'permission' => 
  ...
  array (
    ...
    'encrypt' => false,
    'files' => '/Applications/XAMPP/xamppfiles/htdocs/PAACK_GIGI_V.0.1/starter-kit/storage/framework/sessions',
    'connection' => NULL,
    'table' => 'sessions',
    'store' => NULL,
    'lottery' => 
